    ...
    <View className="flex flex-row items-center justify-center bg-white rounded-lg shadow-sm shadow-neutral-300 mb-3">
      <View className="flex flex-col items-center justify-between p-3">
        <View className="flex flex-row items-center justify-between">
          {/* TODO: Create Geoapify account and replace the url 02:34:00 */}
          <Image
            source={{
              uri: `https://maps.geoapify.com/v1/staticmap?:${destination_longitude}, ${destination_latitude}&=${process.env.EXPO_PUBLIC_GEOAPIFY_API_KEY}`,
            }}
